  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto mt-16 p-6 bg-white rounded-xl border border-gray-200 text-center">
        ...
        <Link href="/login" className="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 transition-colors">
          Sign In
        </Link>
      </div>
    );
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-gray-200 mb-8">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <Link href="/sessions" className="text-xs font-medium text-indigo-600 hover:text-indigo-500 transition-colors">
            View all
          </Link>
        </div>
        {sessions.length === 0 ? (
