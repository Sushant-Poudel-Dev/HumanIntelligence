      ...
      <div className='hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900'>
        ...
        <div className='relative z-10 flex flex-col justify-center px-16 xl:px-20'>
          ...
          <p className='text-lg text-indigo-200/80 leading-relaxed max-w-md mb-10'>
            Anonymous peer support when you need it. Join safe, moderated
            sessions with people who understand what you&apos;re going through.
          </p>
          <div className='space-y-4'>
            {[
              {
                icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
                text: "Fully anonymous — your identity is protected",
              },
              {
                icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
                text: "Safe, moderated group and 1:1 sessions",
              },
              {
                icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
                text: "AI-powered progress insights and support routing",
              },
            ].map((item) => (
              <div
                key={item.text}
              ...
              >
                ...
                <span className='text-sm text-indigo-200/70 leading-relaxed'>
                  {item.text}
                </span>
              </div>
            ))}
