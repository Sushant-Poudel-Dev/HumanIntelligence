...
export default function ProfessionalSignupForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (data.user && !data.session) {
      setError('Please check your email to confirm your account. An admin will verify your professional credentials.');
      setLoading(false);
      return;
    }
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Register as a professional</h2>
        <p className="mt-2 text-sm text-gray-500">
          An admin will verify your credentials before granting access
        </p>
      </div>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-gray-50 px-3 text-gray-500">or register with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="credentials" className="block text-sm font-medium text-gray-700 mb-1.5">
            Credentials / License
          </label>
          <textarea
            id="credentials"
            ...
            required
            rows={3}
            placeholder="e.g., LCSW #12345, PhD Clinical Psychology"
            className="block w-full rounded-lg border border-gray-200 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 focus:outline-none transition-colors resize-none"
          />
          <p className="mt-1.5 text-xs text-gray-400">Required for verification by our admin team</p>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        ...
        <a href="/professional-login" className="font-semibold text-teal-600 hover:text-teal-500 transition-colors">
          Sign in
        </a>
      </p>
